...
> Look at the night sky. Track the positions of the planets with one eye on the calendar date. Keep in mind that one cycle between a planet's highest and lowest point is one loop around the Sun. Can you find any patterns?
...
```{r kepdata}
d.kepler %>%
  kable(caption = 'Table 1. Keplers original data from which he derived his empirical 3rd law', format.args = list(scientific = FALSE), col.names = c('Planet', 'Distance from Sun (AU)', 'Orbital Period (days)', '$\\frac{r^3}{T^2}$')) %>%
